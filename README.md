...
| ---------------------------------------------------------------- | ----------------------------------- | ------ | ---------------------------------------------------------------------------------------------------------------------------------------------------- | ---- |
| [User OpenAPI](https://github.com/CodeFromAnywhere/user-openapi) | Add User Management to your OpenAPI | 🟠     | 🟠 Serve Clerk on https://login.actionschema.com and proxy+extend an OpenAPI                                                                         |      |
...
| [CRUD OpenAPI](https://data.actionschema.com)                    | Turn database into agent-tools      | 🚫     | 🟢 CRUD Only firsst<br>🟢 Semantic search<br>🚫 Config: user separation<br>🔴 CLI<br>🔴 ActionSchema integration<br>🔴 CRUD-Agent                    | 4450 |
| [OpenAPI Explorer](https://explorer.actionschema.com)            | Explore OpenAPI Possibilities       | ⏸️     | 🟢 Simple OpenAPI overview with experimental forms🔴 Manual entry<br>🔴 Aggregate openapis from multiple endpoints<br>🔴 Expose LLM search endpoint. |      |
